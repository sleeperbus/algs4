...
public class Transaction implements Comparable<Transaction> {
	private final String	who;		// custormer
	 ...
	 * @throws IllegalArguemntException if amount is Double.NaN, 
	...
	/**
	 * Initializes a new transaction by parsing a string of the for NAME DATE AMOUNT.
	...
	/**
	 * Returns the name of customer involved in the transaction.
	 * @return the name of customer involved in the transaction.
	 */
	public String who() {
		return who;
	}
	...
	/**
	 * Compare this transaction to that transaction.
	 * @return { a negative integer, a positive integer}, depending
